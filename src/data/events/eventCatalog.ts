...
import chainRecurringInjury from "./chain-recurring-injury.json" with {
  type: "json",
};
import chainReserve from "./chain-reserve.json" with { type: "json" };
import chainRivalRematch from "./chain-rival-rematch.json" with {
  type: "json",
};
import chainSetterAttacker from "./chain-setter-attacker.json" with {
  type: "json",
};
...
import seasonalCommunity from "./seasonal-community.json" with {
  type: "json",
};
