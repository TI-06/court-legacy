-- Fix PostgreSQL 42702 in purchase_shop_item by avoiding ambiguous RETURNS TABLE output names
-- in ON CONFLICT column lists. Use the existing named constraints instead.
