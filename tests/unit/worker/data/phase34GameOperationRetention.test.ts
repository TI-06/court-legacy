...
const migration = readFileSync(
  resolve(process.cwd(), "supabase/migrations/202609250001_phase34_game_operation_retention.sql"),
  "utf8",
);
...
describe("Phase34 game operation retention", () => {
  ...
  it("prunes both legacy and v2 mutation paths to 16 exact replays", () => {
    ...
    expect(migration).toContain("create or replace function public.apply_game_operation(");
    expect(migration).toContain("create or replace function public.apply_game_operation_v2(");
  });
