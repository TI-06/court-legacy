...
const session: AuthSession = {
  userId: "phase16-official-browser-user",
  email: "coach@example.com",
  accessToken: "phase16-official-browser-token",
};

function createSnapshot(): CloudGameSnapshot {
  const state = createInitialGame({
    seed: "phase16-official-browser",
    schoolName: "青葉高校",
    schoolShortName: "青葉",
    coachName: "高橋 監督",
  ...
  return {
    ...
    schoolDbId: "00000000-0000-4000-8000-000000000717",
    revision: 1,
    state: officialState,
...
describe("Phase16 official GameApp match commands", () => {
  it("adopts the authoritative official segment returned after a coach command", async () => {
