...
import { ApiError, type GameApiClient } from "../../../src/services/api/GameApiClient";
...
describe("useGameSession conflict classification", () => {
  it(
    "shows the server rule message without reloading the snapshot for a non-revision 409",
    async () => {
