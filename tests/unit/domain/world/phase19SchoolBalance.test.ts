...
describe("Phase19 rival school balance", () => {
  ...
  it(
    "develops an established rival school faster than an unknown school with the same roster and infrastructure",
    () => {
      ...
      const unknownBefore = averageAbility(
        unknown.state.players[unknown.playerId]!,
      );
