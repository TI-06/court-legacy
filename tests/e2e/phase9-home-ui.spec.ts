...
test("phase9 home keeps the weekly CTA in the initial 360x800 viewport", async ({
  page,
}) => {
...
test("phase9 home exposes official summary in the initial 390x844 viewport", async ({
  page,
}) => {
